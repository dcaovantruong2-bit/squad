...
const PLAYERS = [
  ...
  { id:"bruno_penandes", name:"Bruno Penandes", position:"CAM", atk:8, pac:5, pas:8, def_:3, spc:7, traits:["playmaker","clinical"], description:"Penalty box merchant." },
  // CDM
...
const ALL_PHASES = [
  ...
  { id:"set_piece", name:"Set Piece", weight:"SPC", icon:"🎪", maxCards:2,
